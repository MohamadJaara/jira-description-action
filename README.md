...
| `fix-version-wildcards` | Comma-separated list of JIRA fix versions that should always be treated as a match (e.g., "Not applicable, N/A"). Values are matched literally (case-insensitive). See [Version Comparison](#version-comparison) for details.  | false    | none     |
...
**Always-match fix versions** (e.g., JIRA has "Not applicable"):
